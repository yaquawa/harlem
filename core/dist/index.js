...
var Store = class {
  constructor(name, state) {
    this.writeState = _vue.reactive.call(void 0, state);
    this.readState = _vue.readonly.call(void 0, this.writeState);
    this.name = name;
  ...
  getter(name, getter) {
    ...
    const output = _vue.computed.call(void 0, () => getter(this.state));
...
exports.EVENTS = EVENTS; exports.createStore = createStore; exports.default = src_default; exports.on = on; exports.once = once;
